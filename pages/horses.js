...
export default function HorsesPage() {
  ...
  useEffect(() => {
    ...
    // Chargement des données (démo enrichie en attendant API Racing)
    setTimeout(() => {
      const data = generateDemoRaces();
      // Calculer les indices KAIROS pour chaque cheval
      ...
      setRaces(enriched);
      // Détecter les coups (variation cote > 30%)
      const coups = [];
