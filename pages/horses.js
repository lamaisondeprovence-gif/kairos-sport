    ...
    return (
      ...
      return (
        <div style={{ padding: 20 }}>
          <div style={{ color: '#FF4D6D', fontWeight: 700, marginBottom: 8 }}>❌ Erreur module Photo</div>
          <div style={{ color: '#8892a4', fontSize: 12 }}>{e.message}</div>
        </div>
      );
    }
  };
...
export default dynamic(() => Promise.resolve(HorsesPage), { ssr: false });