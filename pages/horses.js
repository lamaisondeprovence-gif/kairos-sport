...
export default function HorsesPage() {
  ...
  const renderScanner = () => {
    ...
    const displayRaces = showDone ? racesWithStatus : activeRaces.length > 0 ? racesWithStatus : racesWithStatus;
  ...
  const renderCoach = () => {
    ...
    const todayHistory = [
      ...
      ...history.filter(h => !['1','2','3','4','5','6'].includes(String(h.id))),
    ];

    const allHistory = todayHistory;
