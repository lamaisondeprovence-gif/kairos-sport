...
export default function KairosSport() {
  ...
  const renderHome = () => (
    <div style={{ paddingTop: 20 }}>
      ...
      {/* Accès rapide Horses + Learning */}
      <div style={{ display: 'flex', gap: 8, marginBottom: 10 }}>
        <a href="/horses" style={{ flex: 1, background: '#1a0d0d', border: '1px solid #FF6B0044', borderRadius: 12, padding: '12px 8px', textAlign: 'center', textDecoration: 'none', display: 'block' }}>
          <div style={{ fontSize: 20 }}>🐎</div>
          <div style={{ color: '#FF6B00', fontSize: 10, fontWeight: 700, letterSpacing: 1, marginTop: 2 }}>HIPPIQUE</div>
          <div style={{ color: '#4a5568', fontSize: 8 }}>PMU · Quinté · UK Racing</div>
        </a>
        <a href="/learning" style={{ flex: 1, background: '#0a0d1a', border: '1px solid #9B59B644', borderRadius: 12, padding: '12px 8px', textAlign: 'center', textDecoration: 'none', display: 'block' }}>
          <div style={{ fontSize: 20 }}>🧠</div>
          <div style={{ color: '#9B59B6', fontSize: 10, fontWeight: 700, letterSpacing: 1, marginTop: 2 }}>AUTO-LEARN</div>
          <div style={{ color: '#4a5568', fontSize: 8 }}>10 ans · IA · Calibrage</div>
        </a>
      </div>
