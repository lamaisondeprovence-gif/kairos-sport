    ...
    <div style={{ paddingTop: 20 }}>
      ...
      {silenceMode ? (
        <div style={S.cardGold}>
          ...
          <button style={{ ...S.btnSmall, borderColor: '#FFD70044', color: 'var(--gold)' }} onClick={() => { setMinScore(40); loadScanner(40); }}>Abaisser à 40</button>
        </div>
      ) : (
    ...
    <div style={{ paddingTop: 16 }}>
      ...
      {events.length === 0 ? (
        <div style={{ ...S.cardGold, textAlign: 'center', padding: '24px 16px' }}>
          ...
          <button style={{ ...S.btnSmall, marginTop: 12, borderColor: '#FFD70044', color: 'var(--gold)' }} onClick={() => { setMinScore(Math.max(0, minScore - 10)); loadScanner(Math.max(0, minScore - 10)); }}>Baisser le seuil</button>
        </div>
  ...
  const renderSilence = () => (
    <div style={{ paddingTop: 60, textAlign: 'center', padding: '60px 20px 20px' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
        ...
        <button style={{ ...S.btnGhost, color: 'var(--gold)', borderColor: '#FFD70044' }} onClick={() => { setMinScore(40); loadScanner(40); goTo(SCREENS.SCANNER); }}>Abaisser à 40</button>
      </div>
    </div>
  );
