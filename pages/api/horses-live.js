...
function computeKairosProf(horse, going) {
  ...
  score.confrontations = horse.vh > 40 ? 50 : horse.vh > 20 ? 35 : horse.vh > 0 ? 20 : 0;
  ...
  // PÉNALITÉS
  let penalites = 0;
  if (horse.odds < 1.5) penalites -= 100;
  if (horse.odds < 1.3) penalites -= 100;
  if (horse.nbCourses === 0) penalites -= 50; // inconnu
...
function generateVerdict(horse) {
  ...
  if (horse.odds < 1.5 && idx < 700) return '🔴 PIÈGE — sur-favori sans valeur réelle. Éviter absolument.';
